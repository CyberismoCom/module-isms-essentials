...
Risk evaluation is mandatory for assets that are critical for operations (Overall asset criticality: High), but can also been conducted for non-critical assets, if justifiable (e.g. from brand-protection perspective).
